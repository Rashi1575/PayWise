...
from ..dashboard.rewards import get_active_rewards, add_reward
from ..dashboard.target_tracker import update_monthly_savings
from ..utils.db import get_connection, get_user_email  # Updated import
