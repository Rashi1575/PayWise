...
def handle_captcha():
    ...
    user_captcha = get_user_input(f"CAPTCHA: What is {question}? ")
...
# def validate_captcha_interactive():
#     """Interactive CAPTCHA validation"""
#     question, answer = generate_math_captcha()
#     user_answer = input(f"CAPTCHA: What is {question}? ").strip()
